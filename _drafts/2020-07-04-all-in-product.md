...
第二，信息架构。这个通常要描述清楚，某一个功能，需要展示或是用到的信息元素，例如，我这个项目，要做项目成本的功能时，就要把项目成本包括的所有成本元素都列出来。这里，我通常都是使用 Excel 来做，当然，使用脑图工具，也是可以的。
...
在 Linux 服务器上，配置必要的运行环境，部署个把项目，还是可以掌控的，并且，我喜欢这种全面掌控的感觉。

当时，是让产品部门的同事，帮我建了一个虚拟机，然后在数据库服务器上，帮我创建了一个数据库，后面的事就交给我了。
